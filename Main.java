...
public class Main {
	public static void main(String[] args) {
		...
		RSA_Algorithm rsa;
		do {
			rsa = new RSA_Algorithm(primeNumberGenerator(), primeNumberGenerator());
	...
	/** encryption method */
	public static void encryptFile(RSA_Algorithm rsa, Scanner console) {
		...
		try {
			...
			PrintWriter writer = new PrintWriter(new File("/Users/nourramadan/Desktop/Encrypted_File.txt"));
	...
	public static void decryptFile(Scanner console) {
		...
		try {
			...
			PrintWriter writer = new PrintWriter("/Users/nourramadan/Desktop/Decrypted_File.txt");
			...
			RSA_Algorithm rsa = new RSA_Algorithm(Arrays.asList(text.split(" ")));
			rsa.decryption();
